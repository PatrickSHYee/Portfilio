...
!function (t, a) {
	!function (t) {
		...
		;
		a.DEFAULT = {
			parallax: !0, navbarSmall: !1, fadeBetweenPages: !0, php: {
				twitter: "./php/twitter/tweet.php", instagram: "./php/instagram/instagram.php"
			}
		...
		, this.options, a), t(".page-preloader").length ? t(window).on("load", function () {
		...
		}).on("pageshow", function (a) {
			a.originalEvent.persisted && t(".page-preloader").hide();
		}
	...
	, a.prototype.initOwlCarousel = function () {
		if ("undefined" != typeof t.fn.owlCarousel) {
			...
			t(".owl-carousel").each(function () {
				var e = "youplay-carousel-" + a++, o = t(this).attr("data-autoplay"), n = parseFloat(t(this).attr("data-stage-padding") || 0), i = parseFloat(t(this).attr("data-item-padding") || 0);
				t(this).owlCarousel({
					loop: !0, stagePadding: n, dots: !0, autoplay: !!o, autoplayTimeout: o, autoplaySpeed: 600, autoplayHoverPause: !0, responsive: {
						0: { items: 3 },
						500: { items: 4 },
						992: { items: 5 },
						1200: { items: 6 }
			...
			t(this).addClass("owl-carousel").owlCarousel({
				loop: !0, stagePadding: n, nav: !0, dots: !1, autoplay: !!o, autoplayTimeout: o, autoplaySpeed: 600, autoplayHoverPause: !0, navText: ["", ""], responsive: {
					0: { items: 1 },
					500: { items: 2 },
					992: { items: 3 },
					1200: { items: 4 }
			...
			var e = "youplay-carousel-" + a++, o = t(this).attr("data-autoplay");
			t(this).addClass("owl-carousel").owlCarousel({
				loop: !0, nav: !1, autoplay: o ? !0 : !1, autoplayTimeout: o, autoplaySpeed: 600, autoplayHoverPause: !0, items: 1
			}
		).addClass(e);
		});
		}
		...
		if ("undefined" != typeof t.fn.magnificPopup) {
			var a = {
				closeOnContentClick: !0, closeBtnInside: !1, fixedContentPos: !1, mainClass: "mfp-no-margins mfp-img-mobile mfp-with-fade", tLoading: '<div class="preloader"></div>', removalDelay: 300, image: {
					verticalFit: !0, tError: '<a href="%url%">The image #%curr%</a> could not be loaded.'
				}
			};
		...
		, a)), t(".gallery-popup").magnificPopup(t.extend({
			delegate: ".owl-item:not(.cloned) a", type: "image", gallery: {
		...
		if ("undefined" != typeof t.fn.revolution) {
			...
			t(".rs-youplay").each(function () {
				var e = t(this), o = {
					dottedOverlay: "none", navigationType: "bullet", navigationArrows: "solo", navigationStyle: "preview4", fullWidth: e.hasClass("rs-fullwidth") ? "on" : "off", fullScreen: e.hasClass("rs-fullscreen") ? "on" : "off", spinner: "spinner4"
				}
		...
		if ("undefined" != typeof t.fn.isotope) {
			t(".isotope").each(function () {
				var a = t(this).find(".isotope-options"), e = t(this).find(".isotope-list").isotope({
					itemSelector: ".item"
				}
			);
				...
				a.preventDefault(), e.isotope({
					filter: function () {
						...
						if (a) {
							a = a.split(", ");
							for (var e in a) if (a[e].replace(/\s/g, "") === o) return !0;
						}
						return !1;
					}
				});
		...
		this.options.parallax && !this.isMobile && ("undefined" != typeof skrollr && "undefined" == typeof this.skrollr && (this.skrollr = skrollr.init({
			smoothScrolling: !1, forceHeight: !1
		}
		...
		var a = t(this).children(".image"), e = t(this).children(".info");
		t(this).jarallax({
			type: "custom", imgSrc: "data:image/gif; base64, R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", imgWidth: 1, imgHeight: 1, onScroll: function (t) {
				var o = Math.min(250, 250 * (1 - t.visiblePercent)), n = Math.min(150, 150 * (1 - t.visiblePercent));
				a.css({
					transform: "translate3d(0,  " + o + "px,  0)"
				}
			), e.css({
				opacity: t.visiblePercent < 0 ? 1 : t.visiblePercent, transform: "translate3d(0,  " + n + "px,  0)"
			}
			);
			}
		});
	}), t(".youplay-footer-parallax").each(function () {
		var a = t(this).children(".wrapper"), e = t(this).find(".social > .container");
		t(this).jarallax({
			type: "custom", imgSrc: "data:image/gif; base64, R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", imgWidth: 1, imgHeight: 1, onScroll: function (t) {
				...
				transform: "translate3d(0,  0,  0)", opacity: t.visiblePercent < 0 ? 1 : t.visiblePercent
			});
			}
		});
		...
		if (t(".fb-page").length) {
			var a = this;
			t("body").append('<div id="fb-root"></div>'), function (t, a, e) {
		...
		var a = this, e = t(".youplay-instagram");
		if (e.length && a.options.php.instagram) {
			var o = function (t, a) {
				for (var e = ["link", "image", "caption"], o = 0, n = e.length;
				n > o;
				o++) a = a.replace(new RegExp(" {{" + e[o] + "}}", "gi"), t[e[o]]);
				return a;
			}
			;
			e.each(function () {
				var e = t(this), n = {
					userID: e.attr("data-instagram-user-id") || null, count: e.attr("data-instagram-count") || 6, template: e.attr("data-instagram-template") || ['<div class="col-xs-4">',
							'<a href=" {{link;}}" target="_blank">',
							'<img src=" {{image;}}" alt=" {{ caption;}}" class="kh-img-stretch">',
							"    </a>", "</div>"].join(" "), loadingText: "Loading...", failText: "Failed to load data", apiPath: a.options.php.instagram
				};
				n.userID || t.error("If you want to fetch instagram images,  you must define the user ID. How to get it see here - http: //jelled.com/instagram/lookup-user-id"),
					e.html('<div class="col-xs-12">' + n.loadingText + "</div>"), t.getJSON(n.apiPath, {
						ID: n.userID, count: n.count
					}, function (t) {
						ml("");
						for (var i = 0; i < n.count; i++) {
							...
							if ([i])
								...
								if (t.statuses || !t.statuses[i])
									break;
								statuses[i];
							}
							var r = {
								link: s.link, image: s.images.thumbnail.url, caption: s.caption
							};
		...
		var a = t(".youplay-twitter"), e = this;
		if (a.length && e.options.php.twitter) {
			var o = function (t, a) {
				for (var e = ["date", "tweet", "avatar", "url", "retweeted", "screen_name", "user_name"], o = 0, n = e.length;
				n > o;
				o++) a = a.replace(new RegExp(" {{" + e[o] + "}}", "gi"), t[e[o]]);
				return a;
			}
			...
			a.each(function () {
				var a = t(this), n = {
					...
					template: a.attr("data-twitter-template") || ["<div>",
						...
						"{{tweet;}}",
						"    </div>",
						"</div>"].join(" "), loadingText: "Loading...", failText: "Failed to load data", apiPath: e.options.php.twitter
				};
				n.list && !n.username && t.error("If you want to fetch tweets from a list,  you must define the username of the list owner."),
				a.html("<span>" + n.loadingText + "</span>"),
				t.getJSON(n.apiPath, {
					username: n.username, list: n.list, hashtag: n.hashtag, count: n.count, exclude_replies: n.hideReplies
				}
		, function (t) {
			a.html("");
			for (var i = 0; i < n.count; i++) {
		...
		var a = this;
		a.options.fadeBetweenPages && t(".page-preloader").length && a.$document.on("click",
			'a: not(.no-fade):not([target="_blank"]):not(.btn):not(.button):not([href*="#"]):not([href^="mailto"]):not([href^="javascript:"])', function (a) {
				if (!a.isDefaultPrevented() && !t(this).parents(".gallery-popup: eq(0)").length && t(this).attr("href")) {
					var e = this.href;
		...
		t(document).on("click", ".navbar a,  a.btn", function (a) {
			var e = this.hash, o = this.baseURI === window.location.href;
			if (e && "#" !== e && "#!" !== e && o) {
				var n = t(e), i = e.replace(/^#/, "");
		...
		a > this.navbarMaxTop && !this.navbarSmall && (this.navbarSmall = !0, t(".navbar-youplay").addClass("navbar-small")),
		a <= this.navbarMaxTop && this.navbarSmall && (this.navbarSmall = !1, t(".navbar-youplay").removeClass("navbar-small"));
	}
, a.prototype.navbarCollapse = function () {
	var a = this;
	a.$document.on("click", ".navbar-youplay [data-toggle=off-canvas]", function () {
		var a = t(".navbar-youplay").find(t(this).attr("data-target")), e = a.hasClass("collapse");
	...
	this.$document.on("submit", ".youplay-form-ajax", function (a) {
		a.preventDefault();
		var e = t(this), o = e.find('[type="submit"]');
		o.is(".disabled") || o.is("[disabled]") || t.post(t(this).attr("action"), t(this).serialize(), function (t) {
			swal({
				type: "success", title: "Success!", text: t, showConfirmButton: !0, confirmButtonClass: "btn-default"
			}
		), e[0].reset();
		}).fail(function (t) {
			swal({
				type: "error", title: "Error!", text: t.responseText, showConfirmButton: !0, confirmButtonClass: "btn-default"
			}
		);
		});
	});
}, a.prototype.searchToggle = function (a) {
	var e = t(".search-block"), o = e.hasClass("active");
...
, a.prototype.initHexagonRating = function () {
	"undefined" !== t.fn.hexagonProgress && t(".youplay-hexagon-rating: not(.youplay-hexagon-rating-ready)").each(function () {
		var a = parseFloat(t(this).attr("data-max")) || 10, e = parseFloat(t(this).text()) || 0, o = parseFloat(t(this).attr("data-size")) || 120, n = t(this).attr("data-back-color") || "rgba(255, 255, 255, 0.1)", i = t(this).attr("data-front-color") || "#fff";
		t(this).css({
			width: o, height: o
		}
).hexagonProgress({
	value: e / a, size: o, animation: !1, startAngle: (60 + 1e-8) * Math.PI / 180, lineWidth: 2, clip: !0, lineBackFill: {
		color: n
	}
, lineFrontFill: {
	color: i
